  ...
  Papa.parse(file, {
    ...
    complete: function(results) {
      if (results && results.data) {
        ...
        showAppNotification("My Sale CSV uploaded successfully.", "success");
      } else {
    ...
    error: function(err) {
      ...
      showAppNotification("CSV parse error: " + err.message, "error");
    }
  });
  e.target.value = "";
}
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  if (refreshBtn) {
    refreshBtn.addEventListener("click", () => {
      syncMySaleFromFirebase(() => {
        renderSaleUploadHistory();
        showAppNotification("My Sale data refreshed.", "success");
      });
    });
  }
